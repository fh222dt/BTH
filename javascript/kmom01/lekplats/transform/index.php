<?php $title='Transform baddie'; include(__DIR__ . '/header.php'); ?>
 
<div id='flash'>
	<p>Press the mouse button on Mickey Mos to begin the action using CSS3 2D transforms (change form) and CSS3 
		transitions (animate change).</p>
	<table>
		<tr>
		  <td>Rotate x 0.5:</td>
		  <td>Rotate x 1.5:</td>
