...
<h1>Kmom07</h1>
<p>Det här var ett kämpigt moment, som har tagit sin tid att ta sig igenom. Det gick bra i början av tuten.
Jag tycker att sättet att starta upp ett nytt Wooly var väldigt bra förklarat. Och ganska lätt att genomföra. 
Men när sedan alla smågrejer på att-göra-listan i del 3 skulle göras blev det mycket att tänka på. Jag fick 
några underliga felmeddelanden i samband med dessa småfixar. Även i sista delen med dokumentering av alla klasser 
fick jag klura ett bra tag på fel i ena vyn. Men i övrigt har det gått bra. Det är bra att koden 
dokumenterar sig själv, för det har jag svårt för. Vet aldrig vad man ska ha med och inte. Nu 
behöver jag inte tänka på det.</p>

<p>Jag följde tuten för att skapa min testsida i form av Mycontroller, och det gick bra. Du kan besöka min 
testsida här: <a href='mvc/my'>Mycontroller</a>. Jag tittade på mos kod, och gjorde min egen meny precis som 
han gjort. Jag tycker det går väldigt smidigt att installera med hjälp av install-metoden i modules.</p>

<p>Mitt Wooly är ett plain Lydia. Jag har inte gjort något utöver de vi gått igenom. Jag tycker trots det att 
Wooly innehåller det mesta man kan behöva som en grund. Ska man ta det ett steg till är det väl att skapa 
ett proffsigt admingränssnitt där man kan se mer översiktligt vad som finns i ramverket osv. </p>
<p>GitHub: <a href='https://github.com/fh222dt/BTH/releases/tag/v7'>https://github.com/fh222dt/BTH/releases/tag/v7</a></p>

<h1>Kmom06</h1>
<p>Äntligen tänkte jag när jag såg att vi skulle jobba mer med temahantering i detta moment. Jag har länge 
velat lära mig mer om hur man kan tänka kring detta. Det var spännande att göra ett till tema. Jag läste artikeln om 
"Technical web typography". Den var väldigt intressant och jag lärde mig mycket. Har sedan tidigare sett grid-system, 
men jag har aldrig förstått hur man jobbar med det. Det var bra att få använda dessa kunskaper längre fram i 
momentet för att öva. Skummade även artikeln om Fixed vs Fluid. Tror den var skriven 2009, och nu pratas det mest om 
responsivt, så den känndes inte helt aktuell.</p>
<p>Jag har aldrig arbetat med Less förut, och behöver nog läsa på mer om hur man använder det på ett bra sätt. Men 
det jag fick prova på nu var väldigt spännande. Jag gillar mos lösning med autokompilering, och hur man sedan enkelt 
går över till driftsättning. Jag har använt mig av bootstrap i flera småprojekt sedan innan, och tyckt det varit 
smidigt när man snabbt vill ha lite stil på sin sida. </p>
<p>I det här momentet har jag haft mycket strul med det ena och det andra. En massa små saker i varje del av tutorialen 
som jag fått sitta och felsöka. Men allt har löst sig nu efter lite hårt arbete. Mitt tema är lite snyggare än innan med 
en header och logga. Men den är i övrigt likadan som mos. Efter allt slit orkade jag inte hitta på något mer originellt. 
Jag har nu också lagt till alla tools-länkar i footern som jag inte haft tidigare. Sammantaget tycker jag att koden 
har blivit ytterligare ett snäpp bättre efter detta moment. </p>
